...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <form action="" id="form_cari" method="get">
            @csrf
    ...
    <div class="modal fade" id="passwordModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text toggle-password" data-target="#password_new">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" name="password_confirmation" id="password_new_confirmation" class="form-control">
                            <div class="input-group-append">
                                <span class="input-group-text toggle-password" data-target="#password_new_confirmation">
                                    <i class="fas fa-eye"></i>
                                </span>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <button type="button" id="proses_password" class="btn btn-primary">
                        Update Password
                    </button>
                </div>
...
<script>
    ...
    render: function (data, type, row) {
        ...
        btn += '<button type="button" class="btn btn-info btnPassword">Update Password</button>';
    ...
    $("#Tuser tbody").on('click', '.btnPassword', function () {
        ...
        $("#Tuser tbody").on('click','.btnPassword',function(){
            ...
            $("#proses_password").click(function(){
             let postData = new FormData($("#passwordForm")[0]);
            $.ajax({
                url: "{{ route('editor.users.updatepassword') }}",
                type: "POST",
                data: postData,
                dataType: "JSON",
                cache: false,
